...
- `agent-runtime` ships a bottle so `brew install` needs no compiler on the host; see `.github/workflows/bottle.yml`, `.github/scripts/*.sh`, and the README's "Bottle" section for what it is and how the rebuild automation works.
